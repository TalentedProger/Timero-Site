      ...
      <div className="bg-black/40 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-3xl shadow-2xl">
        ...
        {config.path === "/" && (
          <div className="text-left mt-12 space-y-6 text-sm text-white/70 border-t border-white/10 pt-10">
            ...
            <p>Многие инструменты предлагают только сухой обратный отсчёт. В Focus Timer мы пошли дальше: приятные <strong>звуки</strong> оповещают об окончании сессии, помогая не пропустить перерыв. Встроенная <strong>статистика</strong> наглядно показывает, сколько времени было потрачено с пользой каждый день. Красивое визуальное оформление (с возможностью развернуть приложение на полный экран) создаёт идеальное цифровое пространство, чтобы ваша <strong>работа</strong> или <strong>учёба</strong> проходили без лишнего визуального шума. Повышайте качество своей <strong>концентрации</strong> и выводите свою <strong>productivity</strong> на новый уровень вместе с Focus Timer.</p>
          </div>
        )}
