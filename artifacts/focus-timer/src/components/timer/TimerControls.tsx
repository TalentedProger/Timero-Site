  ...
  return (
    <div className="flex items-center justify-center gap-5 mt-8 z-10">
      ...
      <motion.button
        ...
        className={cn(
          "w-14 h-14 rounded-full inline-flex items-center justify-center border border-white/10 bg-white/5 backdrop-blur-sm transition-all hover:bg-white/12 hover:border-white/20",
      ...
      <motion.button
        ...
        className="w-20 h-20 rounded-full inline-flex items-center justify-center transition-all"
        style={{
          background: accent,
        }}
      >
      ...
      <motion.button
        ...
        className="w-14 h-14 rounded-full inline-flex items-center justify-center border border-white/10 bg-white/5 backdrop-blur-sm transition-all hover:bg-white/12 hover:border-white/20"
      >
